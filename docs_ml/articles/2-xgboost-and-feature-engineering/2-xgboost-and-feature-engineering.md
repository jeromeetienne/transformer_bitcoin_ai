...
- **Model**
    - Naive: `pred = close[t-1]`
    - ARIMA(3,1,3): linear AR+MA on differences
    - XGBoost: nonlinear trees on 31 features
- **Parameters**
    - Naive: 0
    - ARIMA(3,1,3): 7
    - XGBoost: ~thousands (tree structure)
- **Sees interactions**
    - Naive: no
    - ARIMA(3,1,3): no
    - XGBoost: yes
